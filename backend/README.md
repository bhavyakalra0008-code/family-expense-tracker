...
> ⚠️ **DEMO-ONLY data** — All credentials below are for local development only.
> Never use these in a production environment.

- **Family**: `The Malhotras`
- **Admin**: `Priya Malhotra` (`priya@malhotra.com` / `Password123!` ← DEMO ONLY)
- **Children**:
  - `Kavya` (Account ending **1234**, PIN **1111** ← DEMO ONLY, Limit ₹5,000)
  - `Arjun` (Account ending **5678**, PIN **2222** ← DEMO ONLY, Limit ₹3,500)
  - `Rohan` (Account ending **9012**, PIN **3333** ← DEMO ONLY, Limit ₹4,000)
